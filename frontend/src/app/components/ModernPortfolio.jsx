...
export default function ModernPortfolio() {
  ...
  const experiences = [
    ...
    },
    {
      ...
      location: 'Bengaluru, Andhra Pradesh',
  ...
  const projects = [
    ...
    },
    {
      ...
      description: 'Full-featured e-commerce platform with cart, wallet, and secure payment integration.',
  ...
  const NavBar = () => (
    <motion.nav
      initial={{ y: -100 }}
      animate={{ y: 0 }}
      className={`fixed top-0 left-0 right-0 z-50 backdrop-blur-lg border-b h-16 ${
      ...
      >
        <div className="max-w-7xl mx-auto">
          ...
          >
            ...
            <motion.h1
              variants={itemVariants}
              className={`text-3xl sm:text-5xl lg:text-6xl font-bold mb-4 md:mb-6 ${
            ...
            <motion.p
              variants={itemVariants}
              className={`text-base md:text-lg mb-8 md:mb-12 max-w-3xl mx-auto ${
            ...
            >
              ...
              <motion.button
                ...
                className={`px-6 py-2 md:px-8 md:py-3 border-2 border-blue-500 text-blue-500 rounded-lg font-semibold flex items-center justify-center space-x-2 hover:bg-blue-500 hover:text-white transition-colors text-sm md:text-base ${
                  isDarkMode ? 'hover:bg-blue-500' : 'hover:bg-blue-500'
                }`}
              >
                <Download size={18} />
