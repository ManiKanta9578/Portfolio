  ...
  return (
    <section className="lg:py-5">
      <div className="grid grid-cols-1 sm:grid-cols-12">
        ...
        >
          <h1 className=" mb-4 text-4xl sm:text-5xl lg:text-7xl lg:leading-normal font-extrabold h-28 sm:h-48">
          ...
          <div>
            ...
            <button
              className="px-1 py-1 w-full sm:w-fit rounded-full bg-gradient-to-br from-primary-500 via-secondary-500 to-light hover:bg-slate-800 text-dark dark:text-light mt-3"
              onClick={handleDownload}
            >
              <a
                href={cvDownloadUrl}
                download="Manikanta's Resume.pdf"
                className="block bg-light dark:bg-[#121212] hover:bg-slate-800 rounded-full px-5 py-2"
              >
                Download CV
              </a>
            </button>
